        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Alle prismodeller hos Magnora Marketing inkluderer skræddersyet kampagneplanlægning, løbende scriptoptimering, CRM-opdatering og månedlig performancerapportering. Vi er fuldt transparente om vores priser og aktivitetsniveau, og fakturerer altid i henhold til det aftalte – ingen overraskelser undervejs. Kontakt Magnora Marketing på mail@magnoramarketing.dk eller mail@magnoramarketing.dk for et skræddersyet tilbud tilpasset din branche og dine vækstmål.
            </p>
