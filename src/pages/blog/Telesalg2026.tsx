    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
          ...
          <li>Klar og præcis value proposition tilpasset den specifikke modtager</li>
          <li>Aktiv lytning og evne til at tilpasse samtalen i realtid</li>
          <li>Professionel og respektfuld indvendingsbehandling</li>
          <li>Vedholdenhed og systematik i opfølgningen</li>
          <li>Positivt mindset og evne til at håndtere afvisninger konstruktivt</li>
        </ul>

        <h2 className="text-2xl font-bold mb-4 mt-10">Salgsscripts der virker i 2026</h2>
        <p className="text-gray-600 mb-4">
          Et godt salgsscript i 2026 er ikke et ord-for-ord manuskript – det er et struktureret framework der sikrer konsistens og professionalisme, men som efterlader plads til naturlig og autentisk kommunikation. De vigtigste elementer i et effektivt telesalgscript er:
        </p>

        <h3 className="text-xl font-semibold mb-3 mt-6">Åbningen – de første 10 sekunder er afgørende</h3>
        <p className="text-gray-600 mb-4">
          Åbningen afgør om samtalen fortsætter eller afbrydes. Den skal være kort, klar og relevant – og straks signalere at du har gjort dit hjemmearbejde. Nævn virksomhedens navn, din reference til noget specifikt ved dem (branche, vækst, et nyligt initiativ), og den konkrete grund til dit opkald. Undgå generiske åbninger som "Forstyrrer jeg?" eller "Har du et par minutter?"
        </p>

        <h3 className="text-xl font-semibold mb-3 mt-6">Value proposition – hvad er din unikke værdiskabelse?</h3>
        <p className="text-gray-600 mb-4">
          Din value proposition skal kommunikeres konkret og relevant for modtageren. Frem for at tale om funktioner og egenskaber ved dit produkt, tal om de konkrete resultater du hjælper virksomheder i deres branche med at opnå. "Vi hjælper IT-virksomheder med at reducere tid til første salgsmøde med 40%" er langt stærkere end "Vi laver B2B mødebooking".
        </p>
