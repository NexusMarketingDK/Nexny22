      ...
      <section className="section bg-sky-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-4">
              Kontakt Magnora Marketing på +45 91 95 27 94 eller kontakt@magnoramarketing.dk for en uforpligtende snak om, hvordan vi kan hjælpe din virksomhed med at accelerere væksten gennem professionel outsourcing af salg og mødebooking.
            </p>
          </div>
        </div>
      </section>
