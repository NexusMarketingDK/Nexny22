export default {
  ...
  info: {
    ...
    addressLines: ['Calle Purisima 5', '46540 El Puig', 'Valencia, Spanien'],
    emailLabel: 'Email',
  ...
  seoBlock: {
    ...
    p3: 'Som samarbejdspartner får I adgang til:',
    accessList: [
    ...
    p4: 'Kontakt os i dag for en uforpligtende snak om, hvordan vi kan hjælpe jeres virksomhed med at nå jeres salgsmål gennem professionel telemarketing og mødebooking.',
  },
  seoText1: {
